...
| 19 | v2.5 | 🔴 의존성 인터페이스 제공 | "see xxx.ts" 금지, brief에 타입 시그니처 포함 | 체인 3 Worker 208K (과도 읽기) |
| 20 | v2.5 | 🔴 Worker 스코프 자급자족 | brief에 필요한 모든 정보 포함 | Worker가 brief 외 파일 읽을 필요 없게 |
| 21 | v2.5 | 🟡 의존성 깊이 기반 분할 | 파일 수→의존성 깊이 기준으로 변경 | 2파일+5의존성=208K vs 4파일+0의존성=170K |
